...
use rapid_routing_MC,only: routing_params_MC,routing_MC
...
use rapid_var, only :                                                          &
                   ...
                   IS_opt_routing,comid,bw,ss,bs,ll,nchan,hinit,& !lpr added
...
call routing_params_MC(comid,bw,ss,bs,ll,nchan,hinit,&
