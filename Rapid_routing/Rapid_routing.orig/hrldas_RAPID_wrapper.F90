...
!--------------RAPID coupler: gridded runoff to vector runoff-----------------------  
  subroutine rapid_runoff_to_inflow(ZM_runoff,ZV_Vlat,cnt_rapid_run)
    ...
    character(len=100) :: rapid_coupling_file='./rapid_input_tx/RAPID_weighted_WRF_hydro.csv'
    ...
    if (rank==0) then
      ...
      if (cnt_rapid_run==1) then
        ...
        close(88)
        print *,'****** RAPID: reading weighted coupling file successfully ****'
