...
print *,'******** Processing JS_localsize= ',idebug,' **********'
print *,' ZV_Qext = ',ZV_Qext_p(idebug)
print *,' --- C1 = ',ZV_C1_p(idebug),'; C2=',ZV_C2_p(idebug),' ; C3=',ZV_C3_p(idebug)
...
!Update mean
!-------------------------------------------------------------------------------
call VecAXPY(ZV_QoutbarR,ZS_one/IS_R,ZV_QoutprevR,ierr) !Qoutbar=Qoutbar+Qoutprev/IS_R
