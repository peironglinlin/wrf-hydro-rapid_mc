...
use rapid_var, only :                                                          &
                   ...
                   MC_C1,MC_C2,MC_C3,MC_C4,MC_A,MC_Km,MC_X,MC_Ck, &   !lpr added
                   ZV_Qlat_r,ZV_Qstore,ZV_Qstoreprev !vars for overland flow
...
!---lpr for overland flow
call VecDuplicate(ZV_k,ZV_Qlat_r,ierr)
call VecDuplicate(ZV_k,ZV_Qstore,ierr)
call VecDuplicate(ZV_k,ZV_Qstoreprev,ierr)
...
!lpr added: for Muskingun-Cunge routing variables--
call VecDuplicate(ZV_k,MC_C1,ierr)
call VecDuplicate(ZV_k,MC_C2,ierr)
call VecDuplicate(ZV_k,MC_C3,ierr)
call VecDuplicate(ZV_k,MC_C4,ierr)
call VecDuplicate(ZV_k,MC_A,ierr)
call VecDuplicate(ZV_k,MC_Km,ierr)
call VecDuplicate(ZV_k,MC_X,ierr)
call VecDuplicate(ZV_k,MC_Ck,ierr)
